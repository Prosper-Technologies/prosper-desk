...
export default function GmailSetupPage() {
  ...
  const { data: integration, refetch: refetchIntegration } = api.gmail.getIntegration.useQuery();
  ...
  const syncEmails = api.gmail.syncEmails.useMutation({
    onSuccess: (data) => {
      setRotateCcwResult(`Processed ${data.messagesProcessed} messages, created ${data.ticketsCreated} new tickets`);
      refetchIntegration();
    },
  });
  ...
  useEffect(() => {
    ...
    if (code && !setupIntegration.isPending) {
      setIsConnecting(true);
      setupIntegration.mutate({ code });
    }
  }, [searchParams, setupIntegration]);
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                              This will stop automatic email-to-ticket conversion. 
                              Existing tickets won't be affected.
                            </AlertDialogDescription>
                          </AlertDialogHeader>
                          <AlertDialogFooter>
                  ...
                  {testConnection.isSuccess && (
                    <div className="rounded-lg bg-green-50 p-3">
                      <p className="text-sm text-green-600">
                        ...
                        Messages: {testConnection.data.messagesTotal}, 
                        Threads: {testConnection.data.threadsTotal}
                      </p>
                    </div>
                  )}
                ...
                <div className="space-y-4">
                  <div className="text-center py-8">
                    ...
                    <p className="mb-6 text-gray-600">
                      Authorize access to your Gmail account to start converting emails into tickets
                    </p>
                    <Button 
            ...
            <CardContent>
              ...
              <div className="mt-6 rounded-lg bg-yellow-50 p-4">
                <div className="flex gap-2">
                  ...
                  <div>
                    <p className="font-medium text-yellow-800">Setup Requirements</p>
                    <ul className="mt-1 text-sm text-yellow-700 space-y-1">
                      <li>• You need admin access to configure Gmail integration</li>
                      <li>• The Gmail account must have appropriate permissions</li>
                      <li>• Manual sync is available, automatic sync coming soon</li>
                    </ul>
                  </div>
                </div>
              </div>
